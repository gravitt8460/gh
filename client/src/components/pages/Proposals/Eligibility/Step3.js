...
const renderProposalDetails = (data = {}) => {
  const { currentAmount, proposedAmount, transactionHash } = data;
  return (
    <div>
      ...
      <Table columns={2} attached>
        <Table.Body>
          ...
          <Table.Row>
            ...
            <Table.Cell>Member eligibility amount</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>Current amount</Table.Cell>
            <Table.Cell>{currentAmount}</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>Proposed amount</Table.Cell>
